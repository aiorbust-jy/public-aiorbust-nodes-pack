# -*- coding: utf-8 -*-
"""
ComfyUI nodes - Aiorbust Prompt Saver / Prompt Gallery.
...
try:
    ...
    if not getattr(PromptServer.instance, "_aiorbust_prompt_lib_routes", False):
        PromptServer.instance._aiorbust_prompt_lib_routes = True

        @PromptServer.instance.routes.get("/aiorbust/prompt_library/list")
        ...
        @PromptServer.instance.routes.get("/aiorbust/prompt_library/thumb")
        ...
        @PromptServer.instance.routes.post("/aiorbust/prompt_library/save")
        ...
        @PromptServer.instance.routes.post("/aiorbust/prompt_library/delete")
    ...
    logging.warning("Aiorbust Prompt Library: routes not registered (server unavailable)")
