# -*- coding: utf-8 -*-
"""
ComfyUI node - Aiorbust RIFE VFI (batched).
...
NODE_CLASS_MAPPINGS = {"AiorbustRifeVfiBatched": AiorbustRifeVfiBatched}
NODE_DISPLAY_NAME_MAPPINGS = {"AiorbustRifeVfiBatched": "Aiorbust RIFE VFI (batched)"}
