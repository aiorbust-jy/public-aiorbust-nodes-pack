/**
 * Aiorbust Resolution (MP) — live preview of the resolution actually produced.
 *
...
async function refresh(node) {
    ...
    try {
        const url = `/aiorbust/resolution_mp/preview`
...
app.registerExtension({
    name: "aiorbust.ResolutionMPPreview",

    nodeCreated(node) {
        if (node.comfyClass !== "AiorbustResolutionMP") return;
