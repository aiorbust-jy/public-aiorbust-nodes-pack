/**
 * Aiorbust Video Chain — reset button.
 *
...
const CHAIN_NODES = ["AiorbustVideoChainPrepare", "AiorbustVideoChainCommit"];

app.registerExtension({
    name: "aiorbust.VideoChain",
    ...
    nodeCreated(node) {
        ...
        const btn = node.addWidget("button", "⟳  Reset chain", null, async () => {
            ...
            try {
                const resp = await fetch("/aiorbust/video_chain/reset", {
                    method: "POST",
